...
const cacheName = 'AlexTaylorKatieWhittelseyFinalBIA375Project-2020-05-01 13:25:48.879755'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'AlexTaylorKatieWhittelseyFinalBIA375Project'.length) === 'AlexTaylorKatieWhittelseyFinalBIA375Project') {
